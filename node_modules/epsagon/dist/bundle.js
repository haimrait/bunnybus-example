...
goog.inherits(proto.Exception, googleProtobuf.Message);
...
proto.Exception.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    traceback: googleProtobuf.Message.getFieldWithDefault(msg, 3, ""),
    time: +googleProtobuf.Message.getFieldWithDefault(msg, 4, 0.0),
  ...
  while (reader.nextField()) {
    ...
    case 5:
      ...
      reader.readMessage(value, function(message, reader) {
        googleProtobuf.Map.deserializeBinary(message, reader, googleProtobuf.BinaryReader.prototype.readString, googleProtobuf.BinaryReader.prototype.readString);
         });
      break;
    default:
      reader.skipField();
...
proto.Exception.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(5, writer, googleProtobuf.BinaryWriter.prototype.writeString, googleProtobuf.BinaryWriter.prototype.writeString);
  }
};
...
proto.Exception.prototype.getTime = function() {
  return /** @type {number} */ (+googleProtobuf.Message.getFieldWithDefault(this, 4, 0.0));
};


/** @param {number} value */
proto.Exception.prototype.setTime = function(value) {
  googleProtobuf.Message.setProto3FloatField(this, 4, value);
};
...
goog.inherits(proto.Resource, googleProtobuf.Message);
if (goog.DEBUG && !COMPILED) {
...
proto.Resource.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    operation: googleProtobuf.Message.getFieldWithDefault(msg, 3, ""),
...
proto.Resource.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(4, writer, googleProtobuf.BinaryWriter.prototype.writeString, googleProtobuf.BinaryWriter.prototype.writeString);
  }
};
...
goog.inherits(proto.Event, googleProtobuf.Message);
if (goog.DEBUG && !COMPILED) {
...
proto.Event.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    startTime: +googleProtobuf.Message.getFieldWithDefault(msg, 2, 0.0),
    resource: (f = msg.getResource()) && proto.Resource.toObject(includeInstance, f),
    origin: googleProtobuf.Message.getFieldWithDefault(msg, 4, ""),
    duration: +googleProtobuf.Message.getFieldWithDefault(msg, 5, 0.0),
    errorCode: googleProtobuf.Message.getFieldWithDefault(msg, 6, 0),
...
proto.Event.prototype.getResource = function() {
  return /** @type{?proto.Resource} */ (
    googleProtobuf.Message.getWrapperField(this, proto.Resource, 3));
};
...
proto.Event.prototype.getDuration = function() {
  return /** @type {number} */ (+googleProtobuf.Message.getFieldWithDefault(this, 5, 0.0));
};
...
proto.Event.prototype.getErrorCode = function() {
  return /** @type {!proto.ErrorCode} */ (googleProtobuf.Message.getFieldWithDefault(this, 6, 0));
};
...
proto.Event.prototype.getException = function() {
  return /** @type{?proto.Exception} */ (
    googleProtobuf.Message.getWrapperField(this, exception_pb.Exception, 7));
};
...
proto.Trace = function(opt_data) {
  googleProtobuf.Message.initialize(this, opt_data, 0, -1, proto.Trace.repeatedFields_, null);
};
goog.inherits(proto.Trace, googleProtobuf.Message);
if (goog.DEBUG && !COMPILED) {
...
proto.Trace.toObject = function(includeInstance, msg) {
  var obj = {
    appName: googleProtobuf.Message.getFieldWithDefault(msg, 1, ""),
    token: googleProtobuf.Message.getFieldWithDefault(msg, 2, ""),
    eventList: googleProtobuf.Message.toObjectList(msg.getEventList(),
    event_pb.Event.toObject, includeInstance),
    exceptionList: googleProtobuf.Message.toObjectList(msg.getExceptionList(),
    exception_pb.Exception.toObject, includeInstance),
    version: googleProtobuf.Message.getFieldWithDefault(msg, 5, ""),
    platform: googleProtobuf.Message.getFieldWithDefault(msg, 6, "")
  };
...
proto.Trace.prototype.getEventList = function() {
  return /** @type{!Array.<!proto.Event>} */ (
    googleProtobuf.Message.getRepeatedWrapperField(this, event_pb.Event, 3));
};
...
proto.Trace.prototype.addEvent = function(opt_value, opt_index) {
  return googleProtobuf.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.Event, opt_index);
};
...
proto.Trace.prototype.getExceptionList = function() {
  return /** @type{!Array.<!proto.Exception>} */ (
    googleProtobuf.Message.getRepeatedWrapperField(this, exception_pb.Exception, 4));
};
...
proto.Trace.prototype.addException = function(opt_value, opt_index) {
  return googleProtobuf.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.Exception, opt_index);
};
...
var loadEC2Metadata = function loadEC2Metadata() {
    ...
    attributeToGet.forEach((attribute) => {
        ...
        promises.push(axios.get(URL$1 + attribute, {
...
module.exports.filterTrace = function filterTrace(traceObject, ignoredKeys, removeIgnoredKeys) {
    ...
    const doesContainIgnoredKey = value => ignoredKeys
        .some((predicate) => {
            if (typeof predicate === 'string' &&
                config_1.processIgnoredKey(value).includes(predicate)) {
                return true;
            }
    ...
    const events$$1 = traceObject.events.map((event$$1) => {
        ...
        filteredEvent.resource.metadata = filterObject(event$$1.resource.metadata);
...
var tracer_9 = tracer.filterTrace;
var tracer_10 = tracer.postTrace;
var tracer_11 = tracer.sendTrace;
var tracer_12 = tracer.sendTraceSync;
var tracer_13 = tracer.label;
var tracer_14 = tracer.setError;
var tracer_15 = tracer.setWarning;
var tracer_16 = tracer.getTraceUrl;
var tracer_17 = tracer.disable;
var tracer_18 = tracer.enable;
var tracer_19 = tracer.getTrimmedTrace;
var tracer_20 = tracer.isLoggingTracingEnabled;
var tracer_21 = tracer.getTraceId;
var tracer_22 = tracer.addLoggingTracingEnabledMetadata;
...
const AWS$1 = try_require('aws-sdk');
    ...
    if (AWS$1) {
        ...
        const item = (
            record.eventName === 'REMOVE' ?
                AWS$1.DynamoDB.Converter.unmarshall(record.dynamodb.Keys) :
                AWS$1.DynamoDB.Converter.unmarshall(record.dynamodb.NewImage)
        );
 ...
 */
function createRunner$1(functionName, originalParams) {
    const runnerResource = new event_pb.Resource([
        functionName,
        'openwhisk_action',
        'invoke',
...
function baseOpenWhiskWrapper(functionToWrap, options) {
    ...
    return (originalParams) => { // eslint-disable-line consistent-return
        ...
        try {
            ...
            runner = createRunner$1(process.env['__OW_ACTION_NAME'], originalParams);
        } catch (err) {
 ...
 * @return {proto.event_pb.Event} The runner representing the lambda
 */
function createRunner$2(functionToWrap, args) {
    const runnerResource = new event_pb.Resource([
...
var nodeWrapper = function nodeWrapper(functionToWrap) {
    ...
    return (...args) => { // eslint-disable-line consistent-return
        ...
        try {
            runner = createRunner$2(functionToWrap, args);
        } catch (err) {
            // If we failed, call the user's function anyway
...
var createRunner_1$1 = createRunner$3;
...
module.exports.getModules = function getModules(id) {
    ...
    searchPaths.forEach((searchPath) => {
        const module = try_require(`${searchPath}/${id}`);
        if (module) {
...
const AWS$2 = try_require('aws-sdk');
...
const dynamoDBEventCreator = {
    ...
    generateItemHash(item) {
        const unmarshalledItem = AWS$2.DynamoDB.Converter.unmarshall(item);
...
var src_2 = src.stepLambdaWrapper;
var src_3 = src.openWhiskWrapper;
var src_4 = src.nodeWrapper;
var src_5 = src.wrapBatchJob;
var src_6 = src.label;
var src_7 = src.setError;
var src_8 = src.setWarning;
var src_9 = src.getTraceUrl;
var src_10 = src.tracer;
var src_11 = src.config;
var src_12 = src.utils;
var src_13 = src.eventInterface;
var src_14 = src.event;
var src_15 = src.tryRequire;
var src_16 = src.errorCode;
var src_17 = src.httpHelpers;
var src_18 = src.consts;
var src_19 = src.sqsUtils;
var src_20 = src.wrapper;
var src_21 = src.init;
var src_22 = src.disable;
var src_23 = src.unpatch;
var src_24 = src.enable;
var src_25 = src.moduleUtils;

exports.default = src;
exports.lambdaWrapper = src_1;
exports.stepLambdaWrapper = src_2;
exports.openWhiskWrapper = src_3;
exports.nodeWrapper = src_4;
exports.wrapBatchJob = src_5;
exports.label = src_6;
exports.setError = src_7;
exports.setWarning = src_8;
exports.getTraceUrl = src_9;
exports.tracer = src_10;
exports.config = src_11;
exports.utils = src_12;
exports.eventInterface = src_13;
exports.event = src_14;
exports.tryRequire = src_15;
exports.errorCode = src_16;
exports.httpHelpers = src_17;
exports.consts = src_18;
exports.sqsUtils = src_19;
exports.wrapper = src_20;
exports.init = src_21;
exports.disable = src_22;
exports.unpatch = src_23;
exports.enable = src_24;
exports.moduleUtils = src_25;

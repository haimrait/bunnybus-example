    ...
    describe('BunnyBusClientFactory', () => {
        ...
        describe('add', () => {
            it('should error when client configuration does not have a name', async () => {
                ...
                expect(() => bunnyBusClientFactory.add(clientConfiguration)).to.throw(Error, '"name" is required');
            });
            ...
            it('should error when client configuration has a name not of type string', async () => {
                ...
                expect(() => bunnyBusClientFactory.add(clientConfiguration)).to.throw(Error, '"name" must be a string');
            });
            ...
            it('should not error when client configuration does not have config', async () => {
                ...
                expect(() => bunnyBusClientFactory.add(clientConfiguration)).to.not.throw();
            });
            ...
            it('should error when client configuration has a config not of type object', async () => {
                ...
                expect(() => bunnyBusClientFactory.add(clientConfiguration)).to.throw(
                    Error,
        ...
        describe('count', () => {
            it('should initialize with 0', async () => {
                expect(bunnyBusClientFactory.count()).to.equal(0);
            });

            it('should be 2 after 2 client configurations are added', async () => {
                bunnyBusClientFactory.add({
                    name: 'client1'
                });
                ...
                expect(bunnyBusClientFactory.count()).to.equal(2);
            });
        });

        describe('get', () => {
            it('should error when client configuration does not exist', async () => {
                expect(() => bunnyBusClientFactory.build('foo')).to.throw(
                    Error,
            ...
            it('should fetch configuration when it exist', async () => {
                ...
                bunnyBusClientFactory.add(clientConfiguration);

                let sut = undefined;
                expect(() => (sut = bunnyBusClientFactory.get('client1'))).to.not.throw();
        ...
        describe('build', () => {
            ...
            it('should have built a client with empty config', async () => {
                ...
                let sut = undefined;
                expect(() => (sut = bunnyBusClientFactory.build('client1'))).to.not.throw();
                expect(sut).to.exist().and.to.be.an.instanceof(BunnyBus);
            });
            ...
            it('should have built a client with config', async () => {
                ...
                expect(() => (sut = bunnyBusClientFactory.build('client1'))).to.not.throw();
                expect(sut).to.exist().and.to.be.an.instanceof(BunnyBus);
                expect(sut.config).to.include(clientConfiguration.config);
            });
        });
    });
});
